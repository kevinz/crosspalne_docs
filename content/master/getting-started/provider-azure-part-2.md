...
添加 {{<hover label="xrd" line="29">}}claim名称{{</hover>}}允许用户在集群级别使用{{<hover label="xrd" line="9">}}虚拟机{{</hover>}}端点访问该 API，或在名称空间中使用{{<hover label="xrd" line="30">}}虚拟机claim{{</hover>}}端点访问该 API。
